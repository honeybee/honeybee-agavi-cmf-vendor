 ...
 *
 * This class extends the 'Entity' class to get the change events and
...
abstract class Comment extends Entity
{
    ...
    /**
     * Returns the current value of the 'text' attribute on this
     * 'Comment' entity. The 'default_value' option set for
     * this attribute is returned if no value was set. If neither a value nor
     * default value was set the 'null_value' option value is returned.
     *
     * @return mixed Value or default value of attribute 'text'. Null value otherwise (defaults to NULL).
     */
