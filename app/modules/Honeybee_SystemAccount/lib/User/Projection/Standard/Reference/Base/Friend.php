 ...
 * 'Friend' entities please see the skeleton
 * class 'Friend'. Modifications to the skeleton
...
/**
 * Serves as the base class to the 'Friend' entity skeleton.
 *
 * This class contains definitions for attributes and their options available
 * on 'Friend' instances. Modifications to getters and setters
 * as well as new additional helper methods should not be placed in here,
 * but be implemented within the skeleton class 'Friend'.
 *
 ...
 */
abstract class Friend extends ReferencedEntity
{
    /**
     * Returns the current value of the 'username' attribute on this
     * 'Friend' entity. The 'default_value' option set for
