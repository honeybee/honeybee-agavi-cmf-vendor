...
namespace Honeybee\SystemAccount\User\Projection\Standard\Reference;

use Honeybee\SystemAccount\User\Projection\Standard\Reference\Base\Friend as BaseFriend;

/**
 * This class may be used to customize the behaviour of the
 * 'Friend' entities and has built-in validation and
 * change tracking.
 *
 *
