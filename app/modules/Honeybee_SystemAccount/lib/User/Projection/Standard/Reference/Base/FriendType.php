 ...
 * the 'Friend' type please see the skeleton
 * class 'FriendType'. Modifications to the skeleton
...
namespace Honeybee\SystemAccount\User\Projection\Standard\Reference\Base;
...
/**
 * Serves as the base class to the 'Friend' type skeleton.
 */
abstract class FriendType extends ReferencedEntityType
{
    /**
     * Creates a new 'FriendType' instance.
     */
    public function __construct(EntityTypeInterface $parent = null, AttributeInterface $parent_attribute = null)
    {
        parent::__construct(
            ...
            new Options(
                array(
                'referenced_type' => '\\Honeybee\\SystemAccount\\User\\Projection\\Standard\\UserType',
    ...
    {
        return '\\Honeybee\\SystemAccount\\User\\Projection\\Standard\\Reference\\Friend';
    }
}
