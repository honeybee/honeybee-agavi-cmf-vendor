define([
    ...
    HtmlRichTextEditor.prototype.keepSyncOptionsConsistent = function() {
        ...
        if (_.isString(editor_config.blockTag)) {
            ...
            _.pull(this.options.dompurify_sync_config.FORBID_TAGS, editor_block_tag);
            this.options.dompurify_sync_config.ALLOWED_TAGS = [ editor_block_tag ].concat(this.options.dompurify_sync_config.ALLOWED_TAGS || []);
        }
        // ensure DOMPurify doesn't forbid the blockAttributes eventually configured for Squire
