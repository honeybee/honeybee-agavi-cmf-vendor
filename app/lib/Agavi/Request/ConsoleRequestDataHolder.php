...
use AgaviConsoleRequestDataHolder;
...
class ConsoleRequestDataHolder extends AgaviConsoleRequestDataHolder implements OutputtypesRequestDataHolderInterface
{
    /**
