...
class CollectionActionFlowTest extends HoneybeeAgaviFlowTestCase
{
    ...
    public function testExecuteRead()
    {
        ...
        $this->assertTagExists(
            'li[data-hb-item-identifier="honeybee.system_account.user-8e56c666-00b4-4d72-9422-a55e2548e0e5-de_DE-1"]'
        );
        $this->assertTagExists(
            'li[data-hb-item-identifier="honeybee.system_account.user-351cd4f5-204c-4e20-854c-fd12f8b7e37c-de_DE-1"]'
        );
    }
}
