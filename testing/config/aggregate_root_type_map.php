...
$aggregate_root_types['honeybee_cmf.test_fixtures.author'] =
    new Honeygavi\Tests\Fixture\BookSchema\Model\Author\AuthorType();
$aggregate_root_types['honeybee_cmf.test_fixtures.book'] =
    new Honeygavi\Tests\Fixture\BookSchema\Model\Book\BookType();
$aggregate_root_types['honeybee_cmf.test_fixtures.publication'] =
    new Honeygavi\Tests\Fixture\BookSchema\Model\Publication\PublicationType();
$aggregate_root_types['honeybee_cmf.test_fixtures.publisher'] =
    new Honeygavi\Tests\Fixture\BookSchema\Model\Publisher\PublisherType();
