...
namespace Honeygavi\Tests\Unit\Ui\ValueObject;

use Honeygavi\Tests\Mock\HoneybeeAgaviUnitTestCase;
use Honeygavi\Ui\ValueObjects\Pagination;

class PaginationTest extends HoneybeeAgaviUnitTestCase
{
    public function testCreateByOffsetForFirstPage()
    {
        ...
        $this->assertInstanceOf('Honeygavi\\Ui\\ValueObjects\\Pagination', $pagination);
