...
namespace Honeygavi\Tests\Unit\Mail;

use Honeygavi\Mail\LoggingSwiftMailer;
use Honeygavi\Mail\Message;
use Honeygavi\Tests\Mock\HoneybeeAgaviUnitTestCase;

class LoggingSwiftMailerTest extends HoneybeeAgaviUnitTestCase
{
    ...
    /**
     * @expectedException Honeygavi\Mail\MessageConfigurationException
     * @codeCoverageIgnore
     */
     ...
     *
     * @return \Honeygavi\Tests\Unit\Mail\TestMailer
     */
